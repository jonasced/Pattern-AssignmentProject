...
def modelvisual(hmm, data_labels, samples, chars=[], overview=False, comparison=False):
    if not overview:
        ...
        featurevisual(model_features, data_labels, model_states, chars=chars, plt_num=[], model=True)
